...
CrmModule = (function(_super) {
  ...
  CrmModule.prototype.getRecordById = function(id, cb) {
    ...
    return request.request((function(_this) {
      return function(err, response) {
        var processed, row, _ref, _ref1, _ref2, _ref3;
        if (err) {
          if (_.isFunction(cb)) {
            return cb(err, null);
          }
          ...
          } else if ((_ref2 = response.data) != null ? _ref2.Contacts : void 0) {
            row = _.first((_ref3 = response.data) != null ? _ref3.Contacts : void 0);
            processed = _this.processRecord(_.first(row.row));
            response.data = processed;
          }
          if (_.isFunction(cb)) {
  ...
  CrmModule.prototype.searchRecords = function(_query, cb) {
    var options, query, request, url;
    if (!_.isObject(_query)) {
      throw new Error('Requires a query object');
    }
